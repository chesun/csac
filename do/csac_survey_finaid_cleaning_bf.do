...
use "/home/research/ca_ed_lab/projects/csac_survey2023/dta/cln/csac_hs_senior_2023_brief_admin.dta",  clear
...
*************************************************************************************
*EFC categories/bins (0, 1 to 6k, 6k to 12k, 12k to 18k, and greater than 18k)
*************************************************************************************
codebook efc 
destring efc, replace
gen efc_bin=.
replace efc_bin=1 if efc==0
replace efc_bin=2 if efc>0 & efc<6000
replace efc_bin=3 if efc>=6000 & efc<12000
replace efc_bin=4 if efc>=12000 & efc<18000
replace efc_bin=5 if efc>18000 & efc!=.
replace efc_bin=6 if efc==.

la def efc_bin 1 "0" 2 "1-5999" 3 "6000-11999" 4 "12,000-17,999" 5 "18k+" 6 "Missing EFC"
la val efc_bin efc_bin 
tab efc_bin,m  
