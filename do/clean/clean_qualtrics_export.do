...
label var t_inf_no_college "time spent on 'which might influence your decision not to attend college', in seconds"
...
rename q29 likely_summer_class
...
rename loan_borrow_amount "how much do you plan to borrow"
...
label var t_worry "time spent on 'how worried are you about following in college' (not discrimination), in seconds"

rename tuition worry_tuition
label var "how worried are you about affording tuition fees"
...
label var worry_support "how worried are you about having adequate support for emotional and mental health needs"
...
label var "I feel prepared for college"

// high school bullying 
rename q58_pagesubmit t_times_bullied
label var t_times_bullied "time spent on 'in last 12 months how many times on school property were you bullied', in seconds"
...
rename q65_pagesubmit t_intro_demo
