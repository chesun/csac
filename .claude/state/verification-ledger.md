...
| do/do_all.do | full-pipeline-run-verified | 2026-06-20T00:00Z | 35a9f0e3c3eb | PASS | Full clean run: all 27 stages' sub-logs opened 2026-06-20 14:24-14:34 in do_all.do order; do_all.txt opened 14:24:13; ~10.5 min; 0 r(NNN); errors in any pipeline log. Only stale non-pipeline logs (merge_dob 2025, make_rct_data 2025, clean_qualtrics_export.log 2023) carry old errors. |
